...
function attachMarkerToCountry( countryName, importance ){
	...
	if(country.exportedAmount > 0 && country.importedAmount > 0) {
	   importExportText += "received:&nbsp;" + numberWithCommas(country.importedAmount) + "<br />" +
	       "performed:&nbsp;"+numberWithCommas(country.exportedAmount);
	} else if(country.exportedAmount > 0 && country.importedAmount == 0) {
	   importExportText += "performed:&nbsp;"+numberWithCommas(country.exportedAmount)+"<br />&nbsp;";
	} else if(country.exportedAmount == 0 && country.importedAmount > 0) {
	   importExportText += "received:&nbsp;"+numberWithCommas(country.importedAmount)+"<br />&nbsp;";
	}
